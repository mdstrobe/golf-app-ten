                  ...
                  <div>
                    <div className="space-y-4">
                      <div className="mb-4">
                        ...
                        <select className="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#15803D] focus:border-transparent">
                      ...
                      <div className="bg-gray-50 rounded-lg p-3 mb-2">
                        <div className="text-sm text-gray-600 mb-2">
                          <span className="font-medium text-gray-700">Quick Actions:</span> Use these to quickly fill in common patterns
                        </div>
                      ...
                      <div className="bg-gray-50 rounded-lg p-3 mb-2">
                        <div className="text-sm text-gray-600">
                          <span className="font-medium text-gray-700">Fairway Indicators:</span> Click to mark where your tee shot landed
                            ...
                            <thead>
                              <tr>
                                ...
                                {[...Array(9)].map((_, i) => (
                                  <th key={i} className="w-11 py-1 px-1 text-center border-b border-gray-200">
                                    <div className="space-y-1">
                                      ...
                                      <div className="text-[10px] font-medium text-gray-500">Par 4</div>
                                    </div>
                                  </th>
                                ))}
                                <th className="w-12 py-1 px-1 text-center border-b border-gray-200">
                                  ...
                                  <div className="text-[10px] font-medium text-gray-500">36</div>
                                </th>
                              </tr>
                            </thead>
                            <tbody>
